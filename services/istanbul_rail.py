    ...
    for cand in results[:max_routes]:
        ...
        if entry > 60:
            ...
            legs.append({
                ...
                "distance_m": entry_m,
                "duration_min": max(1, round(entry_m / 70)),
                "walking_distance_m": entry_m,
                "walking_duration_min": max(1, round(entry_m / 70)),
                "departure_time": None,
                "arrival_time": None,
                "from_stop": None,
                "to_stop": first["name"],
        ...
        if cand["walk_out_m"] > 60:
            ...
            legs.append({
                ...
                "duration_min": max(1, round(cand["walk_out_m"] / 70)),
                "walking_distance_m": round(cand["walk_out_m"]),
                "walking_duration_min": max(1, round(cand["walk_out_m"] / 70)),
                "departure_time": None,
                "arrival_time": None,
                "from_stop": last["name"],
                "to_stop": None,
