...
export function IconMetro({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
...
export function IconTram({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M2 8h3" />
      <path d="M19 8h3" />
      <circle cx="8.5" cy="13.5" r="0.75" fill="currentColor" />
      <circle cx="15.5" cy="13.5" r="0.75" fill="currentColor" />
      <path d="m8 16.5-1.5 3.5" />
      <path d="m16 16.5 1.5 3.5" />
      <path d="M8 20h8" />
    </svg>
  )
}
...
export function IconSparkle({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M9.9 4.2 11 1.5a.6.6 0 0 1 1.1 0l1.1 2.7a2 2 0 0 0 1.1 1.1l2.7 1.1a.6.6 0 0 1 0 1.1l-2.7 1.1a2 2 0 0 0-1.1 1.1L12.1 12a.6.6 0 0 1-1.1 0l-1.1-2.7a2 2 0 0 0-1.1-1.1L6.1 7.1a.6.6 0 0 1 0-1.1l2.7-1.1a2 2 0 0 0 1.1-1.1Z" />
      <path d="M17.5 15.5 18 14a.5.5 0 0 1 1 0l.5 1.5L21 16a.5.5 0 0 1 0 1l-1.5.5L19 19a.5.5 0 0 1-1 0l-.5-1.5L16 17a.5.5 0 0 1 0-1l1.5-.5Z" />
    </svg>
  )
}
...
export function IconSend({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M14.5 21 12 15l6-3-15-9 4 18 4.5-6Z" />
    </svg>
  )
}
...
export function IconLogo({ className }: IconProps) {
  return (
    <svg viewBox="0 0 32 32" fill="none" className={className} aria-hidden="true">
      ...
      <path d="M10 22 16 9l6 13" stroke="var(--color-accent-ink)" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      <circle cx="16" cy="18.5" r="2.2" fill="var(--color-accent-ink)" />
    </svg>
  )
}
